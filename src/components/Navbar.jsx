                    ...
                    <nav className="flex items-center gap-8 py-2.5 text-sm font-medium text-slate-700">
                        {navLinks.map((link) => (
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `relative transition-colors duration-300 after:content-[''] after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:bg-blue-600 after:transition-all after:duration-300 ${
                                        isActive
                        ...
                        <nav className="flex flex-col py-2">
                            {navLinks.map((link) => (
                                <NavLink
                                    ...
                                    onClick={() => setMobileMenuOpen(false)}
                                    className={({ isActive }) =>
                                        `px-5 py-3 text-sm font-medium transition-colors duration-200 ${
                                            isActive
