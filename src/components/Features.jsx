          ...
          if (comingSoon) {
            return (
              <div
                ...
                className="flex items-center gap-3 p-4 rounded-2xl border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer relative"
              >
                {content}
              </div>
            )
