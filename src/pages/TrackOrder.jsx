        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-14">
                ...
                <div className="relative max-w-2xl mx-auto px-4 text-center">
                    ...
                    <p className="text-slate-500 mb-8">Check the live status of any order you've placed with us</p>
                        ...
                        <>
                            <form onSubmit={handleTrack} className="flex flex-col sm:flex-row gap-3 mb-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 rounded-full border border-slate-200 text-sm focus:outline-none focus:border-blue-500"
                                />
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full font-medium hover:shadow-lg hover:shadow-blue-200 transition-all duration-300 disabled:opacity-50"
                                >
                                    <FiSearch size={16} />
            ...
            {order && (
                <section className="max-w-2xl mx-auto px-4 py-12">
                    ...
                    >
                        Order <span className="font-semibold text-blue-600">{order.order_number}</span>
                    </motion.p>
                    ...
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="rounded-3xl bg-white shadow-xl shadow-slate-200/60 border border-slate-100 p-6 text-left mb-8"
                    >
